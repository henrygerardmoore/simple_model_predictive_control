mod simple_continuous_mpc {
    ...
    use crate::{mpc_controller::DynamicsFunction, mpc_controller_builder::MPCControllerBuilder};
    ...
    fn test_simple_continuous_mpc() {
        let mut mpc_controller = MPCControllerBuilder::<STATE_SIZE, INPUT_SIZE>::new()
        ...
        let result = mpc_controller.optimize();
    }
}
